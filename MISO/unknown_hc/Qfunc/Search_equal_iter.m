...
for i = 1:length(P)
    ...
    while 1
        ...
        for j = 1:length(Q)
            ...
            error(j) = error_c + error_s(j) - error_c .* error_s(j);error(error>1) = nan;
...
for i = 1:length(P)
    ...
    f_x_P_Dc2(i) = min(minAoI_iter);minAoI_iter = [];
    m_best(i) = m_iter;
    M12(i) = m_iter;
    QQ12(:,:,i) = Q_iter;       
end
...
%         m_iter = m0;
    ...
    f_x_Dc_d1(i) = min(minAoI_iter);minAoI_iter = [];
    m_best(i) = m_iter;
    M21(i) = m_iter;
    QQ21(:,:,i) = Q_iter;       
end
...
%         m_iter = m0;
    ...
    f_x_Ds_d2(i) = min(minAoI_iter);minAoI_iter = [];
    m_best(i) = m_iter;
    M32(i) = m_iter;
    QQ32(:,:,i) = Q_iter;      
end
...
%         m_iter = m0;
    ...
    f_x_d_Ds1(i) = min(minAoI_iter);minAoI_iter = [];
    m_best(i) = m_iter;
    M41(i) = m_iter;
    QQ41(:,:,i) = Q_iter;      
end
...
%         m_iter = m0;
    ...
    f_x_d_Ds2(i) = min(minAoI_iter);minAoI_iter = [];
    M42(i) = m_iter;
    QQ42(:,:,i) = Q_iter;     
end
