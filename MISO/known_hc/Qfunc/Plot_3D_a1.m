...
figure(1)
surf(m,q1,AoI);zlim([10 900]);caxis([10 900]); shading interp;xlabel('m');ylabel('q1');zlabel('AoI');run plot_setting.m
figure(2)   
surf(m,q1,error);shading interp;xlabel('m');ylabel('q1');zlabel('error');zlim([10^(-50) 0.2]);caxis([10^(-50) 0.2]);run plot_setting.m
