...
for i = 1:length(P)
    ...
    minAoI_Alg_P_Dc1(i) = min(minAoI_iter);
end
Dc = 4;
for i = 1:length(P)
    mc_iter = m_c(1000);
    ...
    minAoI_Alg_P_Dc2(i) = min(minAoI_iter);
end
%% Dc %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
run channelParameter2.m;
Dc = 1:0.7:4;
...
for i = 1:length(Dc)
    ...
    minAoI_Alg_Dc_d1(i) = min(minAoI_iter);
end
d = 128;
for i = 1:length(Dc)
    mc_iter = m_c(1000);
    ...
    minAoI_Alg_Dc_d2(i) = min(minAoI_iter);
end
%% Ds %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
run channelParameter2.m;
Ds = 2:3:16;
...
for i = 1:length(Ds)
    ...
    minAoI_Alg_Ds_d1(i) = min(minAoI_iter);
end
d = 128;
for i = 1:length(Ds)
    mc_iter = m_c(1000);
    ...
    minAoI_Alg_Ds_d2(i) = min(minAoI_iter);
end
%% d %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
run channelParameter2.m;
d = 60:80:450;
...
for i = 1:length(d)
    ...
    minAoI_Alg_d_Ds1(i) = min(minAoI_iter);
end
Ds = 10;
for i = 1:length(d)
    mc_iter = m_c(1000);
    ...
    minAoI_Alg_d_Ds2(i) = min(minAoI_iter);
end
