...
m_s = [0.001:0.5:1000];       %%%% AoI 不超过1s
m_c = [0.001:0.5:1000]';      % finite blocklength 通常默认到2000，通常3000以上认为是infinite blocklength
kappa = -log(10^(-3));
d = 80;

% 默认communication distance = 1

rc = 0.5;           % reflection coefficient, named alpha in article
theta_s = pi/6;
theta_c = pi/3;
